...
const MaintenanceCrewSignUpForm = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const res = await axios.post("http://localhost:7000/users/signup/fieldworker/", {
                username: formData.username,
                email: formData.email,
                password: formData.password,
                phone_number: formData.phone_number,
                department: formData.department,
                assigned_ward: formData.assigned_ward,
            });
            setMessage(res.data.message || "Signup successful!");
            setFormData({ username: '', email: '', password: '', reenterPassword: '', phone_number: '', department: '', assigned_ward: '' });
        } catch (err) {
        ...
        <form onSubmit={handleSubmit}>
            ...
            <div className="input-group">
                <select
                    ...
                    required
                >
                    <option value="" disabled>Assigned Ward</option>
