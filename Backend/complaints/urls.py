...
urlpatterns = [
    ...
    path('<int:complaint_id>/predict-resolution/', PredictComplaintResolutionView.as_view(), name='predict-resolution'),
    path('department-suggestion/', DepartmentSuggestionView.as_view(), name='department-suggestion'),
]